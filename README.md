...
Incorrect exercise posture leading to slower recovery
Manual repetition counting
Missed therapy sessions
Expensive and frequent hospital visits
...
Verifies whether exercises are performed correctly
Provides instant posture correction
...
Secure patient login and signup.

Manage personal rehabilitation sessions.


🏋️ Exercise Selection

Choose from available physiotherapy exercises.

Examples: Knee Bend, Arm Raise, Shoulder Stretch.


📷 AI Pose Detection

Uses the device camera to detect body posture in real time.

Monitors exercise movements using AI.


💬 Real-Time Feedback

Provides instant posture correction during exercises.
...
Automatically counts each correct repetition.

Prevents incorrect or incomplete repetitions from being counted.


⏱️ Exercise Timer

Displays the remaining exercise time.

Helps users complete exercises within the recommended duration.
...
Displays total repetitions completed.

Shows posture accuracy and overall progress over time.